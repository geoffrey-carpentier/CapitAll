...
- services : logique métier (PRU moyen pondéré, plus-value latente, consolidation du portefeuille)
...
5. le service calcule PRU, plus-value latente par actif et valeur totale
